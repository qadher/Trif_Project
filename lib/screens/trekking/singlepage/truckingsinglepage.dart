...
Future<HouseBoatGalleryModel> fetchGallery(int id) async {
  final response =
      await http.post(Uri.parse(Api.apiUrl + 'trucking/gallery/$id'));
...
class TruckingSinglePagePackage extends StatefulWidget {
  ...
  @override
  _TruckingSinglePagePackageState createState() =>
      _TruckingSinglePagePackageState();
}
                          ...
                          child: Column(
                            children: [
                              Stack(
                                clipBehavior: Clip.none,
                                children: [
                                  snapshot.data!.trucking!.image!.isEmpty ||
                                          snapshot.data!.trucking!.image == null
                                      ? Container(
                                          height: 500,
