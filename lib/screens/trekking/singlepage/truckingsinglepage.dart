...
import 'package:trip_calicut/screens/trekking/singlepage/truckingsinglepagecontroller.dart';

import '../../resort/singlepage/resortsinglepagecontroller.dart';

class TruckingSinglePage extends StatelessWidget {
  final TruckingSinglePageController truckingController =
      Get.put(TruckingSinglePageController());
  ...
  final truckingCardDescription = Get.arguments[1];
  final truckingCardInclusion = Get.arguments[2];
  final truckingCardExclusion = Get.arguments[3];
  TruckingSinglePage({Key? key}) : super(key: key);
  static final tourItemId = Get.arguments[0];

  static final client = new http.Client();

  static Future fetchTourData({String? api}) async {
    var responses =
                        ...
                        child: Column(
                          children: [
                            Stack(
                              clipBehavior: Clip.none,
                              children: [
                                truckingController.truckingData.value.image ==
                                        null
                                    ? Container(
                                        height: 500,
                                        ...
                                        children: [
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                truckingController.truckingData
                                                            .value.district ==
                                                        null
                                                    ? 'Kerala'
                                                    : "${truckingController.truckingData.value.district},${truckingController.truckingData.value.state},${truckingController.truckingData.value.country}",
                                                style: TextStyle(
                                                    fontSize: 16,
                                ...
                                Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        'Price Starts from ₹${truckingController.truckingData.value.offerAmount}/-',
                                        style: TextStyle(
                                            fontSize: 22,
                                            fontWeight: FontWeight.bold,
                                            color: Colors.white),
