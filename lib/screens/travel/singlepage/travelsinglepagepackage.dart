...
Future<HouseBoatGalleryModel> fetchGallery(int id) async {
  final response = await http.post(Uri.parse(Api.apiUrl + 'travels/gallery/$id'));
...
class TravelSinglePagePackage extends StatefulWidget {
  ...
  @override
  _TravelSinglePagePackageState createState() => _TravelSinglePagePackageState();
}

class _TravelSinglePagePackageState extends State<TravelSinglePagePackage> {
      ...
      body: Center(
        child: FutureBuilder<TravelsSinglepageModel>(
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              name = snapshot.data!.travel!.name!;
              icon = DbController.updateIcon(name: snapshot.data!.travel!.name!);
              return Stack(
                children: <Widget>[
                          ...
                          child: Column(
                            children: [
                              Stack(
                                clipBehavior: Clip.none,
                                children: [
                                  snapshot.data!.travel!.image!.isEmpty || snapshot.data!.travel!.image == null
                                      ? Container(
                                          height: 500,
                                      ...
                                      : Container(
                                          ...
                                          decoration: BoxDecoration(
                                              image: DecorationImage(
                                                  colorFilter: ColorFilter.mode(Colors.black.withOpacity(0.4), BlendMode.darken),
                                                  image: NetworkImage(Api.imageUrl + snapshot.data!.travel!.image.toString()),
                                                  fit: BoxFit.cover),
                                              color: Colors.black),
                                        ),
                                  Positioned(
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: Text(
                                                    ...
                                                    snapshot.data!.travel!.name.toString(),
                                                    maxLines: 1,
                                            ...
                                            InkWell(
                                              onTap: () async {
                                                await DbController.updateFav(
                                                  name: snapshot.data!.travel!.name.toString(),
                                                  item: TrifsDB(
                                                      id: itemId,
                                                      type: _type,
                                                      image: snapshot.data!.travel!.image!,
                                                      title: snapshot.data!.travel!.name.toString(),
                                                      desc: '',
                                                      fav: true),
                                                );
                        ...
                        children: [
                          GestureDetector(
                            onTap: () {
                              ...
                              enquiryMethod(
                                  type: 'Enquiry',
                                  packageType: 'OnlyTravel',
                                  packageId: '${snapshot.data!.travel!.id}',
                                  agencyId: '${snapshot.data!.travel!.agencyId}',
                                  customerId: '111');
                              // succes show dialog
                              showDialog(
                                  context: context,
