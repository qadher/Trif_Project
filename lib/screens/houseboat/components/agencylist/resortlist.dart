...
class ResortList extends StatelessWidget {
  ...
  final agentId;
  final ResortApiCardController resortController = Get.put(ResortApiCardController());
      ...
      () {
        if (controller.isLoading.value) {
          ...
          return ListView.separated(
            ...
            shrinkWrap: true,
            itemCount: resortController.resortData.value.length,
            separatorBuilder: (context, index) => SizedBox(
              height: 10,
            ),
            itemBuilder: (context, index) => resortController.resortData.value[index].agencyId == agentId ? GestureDetector(
              onTap: () {
                ...
                child: Stack(
                  children: [
                    Container(
                      ...
                      child: Row(
                        children: [
                          resortController.resortData.value[index].image!.isEmpty ||
                                resortController.resortData.value[index].image == null ?
                          Container(
                            height: 12.h,
                            width: 26.w,
                            decoration: BoxDecoration(
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: 
                                 NetworkImage(Api.imageUrl + '${resortController.resortData.value[index].image}'),
                                fit: BoxFit.cover,
                              ),
                            ),
                          ),
                          ...
                          Column(
                            ...
                            children: [
                              Container(
                                width: 30.w,
                                child: Text(
                                  '${resortController.resortData.value[index].name}',
                                  maxLines: 1,
