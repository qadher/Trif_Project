      ...
      () {
        if (controller.isLoading.value) {
          ...
          return ListView.separated(
            ...
            shrinkWrap: true,
            itemCount: homeStayController.homeStayData.value.length,
            separatorBuilder: (context, index) => SizedBox(
              height: 10,
            ),
            itemBuilder: (context, index) => homeStayController.homeStayData.value[index].agencyId == agentId
                ? GestureDetector(
                    onTap: () {
                      ...
                      child: Stack(
                        children: [
                          Container(
                            ...
                            child: Row(
                              children: [
                                homeStayController.homeStayData.value[index].image!.isEmpty ||
                                        homeStayController.homeStayData.value[index].image == null
                                    ? Container(
                                        height: 12.h,
                                        width: 26.w,
                                        decoration: BoxDecoration(
                                    ...
                                    : Container(
                                        ...
                                        decoration: BoxDecoration(
                                          borderRadius: BorderRadius.circular(20),
                                          image: DecorationImage(
                                            image: NetworkImage(Api.imageUrl + '${homeStayController.homeStayData.value[index].image}'),
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                      ),
                                ...
                                Column(
                                  ...
                                  children: [
                                    Container(
                                      width: 30.w,
                                      child: Text(
                                        '${homeStayController.homeStayData.value[index].name}',
                                        maxLines: 1,
