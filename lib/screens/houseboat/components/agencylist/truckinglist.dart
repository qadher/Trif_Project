...
class TruckingList extends StatelessWidget {
      ...
      () {
        if (controller.isLoading.value) {
          ...
          return ListView.separated(
            ...
            shrinkWrap: true,
            itemCount: truckingController.truckingPackageData.value.length,
            separatorBuilder: (context, index) => SizedBox(
              height: 10,
            ),
            itemBuilder: (context, index) => truckingController.truckingPackageData.value[index].agencyId == agentId
                ? GestureDetector(
                    onTap: () {
                      ...
                      child: Stack(
                        children: [
                          Container(
                            ...
                            child: Row(
                              children: [
                                truckingController.truckingPackageData.value[index].image!.isEmpty ||
                                        truckingController.truckingPackageData.value[index].image == null
                                    ? Container(
                                        height: 12.h,
                                        width: 26.w,
                                        decoration: BoxDecoration(
                                    ...
                                    : Container(
                                        ...
                                        decoration: BoxDecoration(
                                          borderRadius: BorderRadius.circular(20),
                                          image: DecorationImage(
                                            image: NetworkImage(Api.imageUrl + '${truckingController.truckingPackageData.value[index].image}'),
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                      ),
                                ...
                                Column(
                                  ...
                                  children: [
                                    Container(
                                      width: 30.w,
                                      child: Text(
                                        '${truckingController.truckingPackageData.value[index].name}',
                                        maxLines: 1,
