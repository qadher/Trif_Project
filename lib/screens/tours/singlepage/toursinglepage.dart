...
import 'package:trip_calicut/screens/tours/singlepage/toursinglepagecontroller.dart';

import '../../resort/singlepage/resortsinglepagecontroller.dart';

class TourSinglePage extends StatelessWidget {
  final TourSinglePageController tourController =
      Get.put(TourSinglePageController());

  final PlaceGalleryController galleryController =
      Get.put(PlaceGalleryController());

  final tourCardImage = Get.arguments[1];
  final tourCardName = Get.arguments[2];
  TourSinglePage({Key? key}) : super(key: key);
                                        ...
                                        children: [
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                tourController.tourData.value
                                                            .district ==
                                                        null
                                                    ? 'Kerala'
                                                    : "${tourController.tourData.value.district},${tourController.tourData.value.state},${tourController.tourData.value.country}",
                                                style: TextStyle(
                                                    fontSize: 16,
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: Padding(
                                        ...
                                        child: Text(
                                          '${tourController.tourData.value.desc}',
                                          maxLines: 1,
                                          style: TextStyle(
                                              fontSize: 20,
                                              fontWeight: FontWeight.bold,
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              SizedBox(
                                                                  height: 10),
                                                              Text(
                                                                '${tourController.tourData.value.history}',
                                                                style: TextStyle(
                                                                    fontSize:
                                                                        13),
                                                              ),
