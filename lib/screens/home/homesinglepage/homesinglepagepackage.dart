...
Future<PackageSinglePageModel> fetchSinglePage(int id) async {
  final response = await http.post(Uri.parse(Api.apiUrl + 'packages/$id'));

// Appropriate action depending upon the

// server response
  if (response.statusCode == 200) {
    return PackageSinglePageModel.fromJson(json.decode(response.body));
  } else {
...
Future<HouseBoatGalleryModel> fetchGallery(int id) async {
  final response =
      await http.post(Uri.parse(Api.apiUrl + 'packages/gallery/$id'));
...
Future<HouseBoatVideosModel> fetchVideos(int id) async {
  final response =
      await http.post(Uri.parse(Api.apiUrl + 'packages/videos/$id'));
...
class HomeSinglePagePackage extends StatefulWidget {
  HomeSinglePagePackage({Key? key}) : super(key: key);

  @override
  _HomeSinglePagePackageState createState() =>
      _HomeSinglePagePackageState();
}

class _HomeSinglePagePackageState
    extends State<HomeSinglePagePackage> {
  Future<PackageSinglePageModel>? futurePackage;
  ...
  final String _type = 'homerecomend';
  String name = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: SafeArea(
          child: Center(
            child: FutureBuilder<PackageSinglePageModel>(
              future: futurePackage,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  name = snapshot.data!.package!.name!;
                  icon =
                    DbController.updateIcon(name: snapshot.data!.package!.name!);
                  return Stack(
                    children: <Widget>[
                              ...
                              child: Column(
                                children: [
                                  Stack(
                                    clipBehavior: Clip.none,
                                    children: [
                                      snapshot.data!.package!.image!.isEmpty ||
                                              snapshot.data!.package!.image ==
                                                  null
                                          ? Container(
                                              height: 500,
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                onTap: () async {
                                                  ...
                                                  // print(itemId);
                                                  // print(_type);
                                                  // print(snapshot.data!.package!.image!);
                                                  // print(snapshot.data!.package!.name.toString());
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(
                                        child: Text(
                                          'Price Starts from ₹${snapshot.data!.package!.offerAmount}/-',
                                          style: TextStyle(
                                              fontSize: 22,
                                              fontWeight: FontWeight.bold,
                                              color: Colors.white),
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                SizedBox(
                                                                    height: 20),
                                                                    Text('${snapshot.data!.package!.days}',style: TextStyle(fontSize: 15),),
                                                                SizedBox(
                                                                    height: 20),
                                                                Text(
                                                                  'Inclusion',
                                                                ...
                                                                SizedBox(
                                                                    height: 10),
                                                                Text(
                                                                  '${snapshot.data!.package!.inclusion}',
                                                                  style: TextStyle(
                                                                      fontSize:
                                                                          13),
                                                                ),
                                                                ...
                                                                SizedBox(
                                                                    height: 10),
                                                                Text(
                                                                  '${snapshot.data!.package!.exclusion}',
                                                                  style: TextStyle(
                                                                      fontSize:
                                                                          13),
                                                                ),
